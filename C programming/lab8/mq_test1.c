...
int main(int argc, char** argv){
	mqd_t msg_queue = mq_open("/ITF22519-Queue", O_RDWR | O_CREAT, S_IRUSR | S_IWUSR | S_IRGRP, NULL);
	if(msg_queue == -1){
		perror("mq_open\n");
		return -1;
	}
	
	char my_string1[] = "I am the third year student.";
	char my_string2[] = "I am the second year student.";
